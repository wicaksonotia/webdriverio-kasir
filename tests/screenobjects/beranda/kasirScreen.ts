...
class KasirScreen extends AppScreen {
    ...
    private get prDoveGoFreshPink () { return $('~pilihProduk0'); }
    private get prDownyAntiBacteria () { return $('~pilihProduk1'); }
    ...
    private get prDjarumSuperMild () { return $('~pilihProduk7'); }
    ...
    async clickProduct6 () {
        ...
        await this.prDjarumSuperMild.click();
    }

    async clickProduct7 () {
        await this.prDoveGoFreshPink.click();
    }

    async clickProduct8 () {
        await this.prDownyAntiBacteria.click();
    }
